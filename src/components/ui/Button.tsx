...
// Source: uipulse.dev (https://github.com/alexrobaina/uipulse) — atoms/Button.
// Extended with brand* variants that match Hello Galaxy's existing look.
  ...
  ],
  {
    variants: {
      variant: {
        ...
        // --- Hello Galaxy brand variants (match existing CTAs) ---
        brand: [
